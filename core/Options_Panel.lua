...
function O.Create()
  ...
  local addonVersion = (GetAddOnMetadata and GetAddOnMetadata("FlexxUI", "Version")) or "dev"
  ...
  local close = O.MakeFlatButton(panel, "X", 26, 20, function() panel:Hide() end)
  ...
  O.MakeTabButton(panel, "Debug", "debug", tabUnit)
  ...
  local debugHolder = O.CreateScrollablePage(panel)
  debugHolder:SetPoint("TOPLEFT", tabUnit, "BOTTOMLEFT", 0, -8)
  debugHolder:SetPoint("BOTTOMRIGHT", panel, "BOTTOMRIGHT", pageBRX, pageBRY)
  O.state.pages.debug = debugHolder.content
  O.state.pageHolders.debug = debugHolder
  ...
  O.BuildDebugPage(O.state.pages.debug)
